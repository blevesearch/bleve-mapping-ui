...
func staticBleveMappingPartialsAnalysisTokenizersExceptionHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "static-bleve-mapping/partials/analysis/tokenizers/exception.html", size: 1379, mode: os.FileMode(420), modTime: time.Unix(1457964404, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
